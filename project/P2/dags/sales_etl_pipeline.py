...
# GCS bucket 
GCS_BUCKET = "p2-team1-final"

# Database connections configuration
# Giving connection name (Given In Airflow), table name
DB_CONNECTIONS = {
...
def load_to_bigquery(df, **kwargs):
    ...
    dataset_id = "the-retina-457110-i6.p2_dataset"  # Replace with your project and dataset name
    table_id = f"{dataset_id}.p2_table"  # Example table name
